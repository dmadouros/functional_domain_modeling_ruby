...
class WidgetsInc::Types::Address
  ...
  def address_line_3(); end

  def address_line_4(); end
...
class WidgetsInc::Types::CustomerInfo
...
class WidgetsInc::Types::PersonalName
  def first_name(); end
...
class WidgetsInc::Types::PricedOrder
  def amount_to_bill(); end

  def billing_address(); end

  def customer_info(); end
...
class WidgetsInc::Types::PricedOrderLine
  def line_price(); end

  def order_line_id(); end
...
class WidgetsInc::Types::UnvalidatedAddress
  def address_line_1(); end
...
class WidgetsInc::Types::UnvalidatedCustomerInfo
  def email_address(); end
...
class WidgetsInc::Types::UnvalidatedOrder
  def billing_address(); end
...
class WidgetsInc::Types::UnvalidatedOrderLine
  def order_line_id(); end
...
class WidgetsInc::Types::ValidatedOrder
  def billing_address(); end
...
class WidgetsInc::Types::ValidatedOrderLine
  def order_line_id(); end
...
module WidgetsInc
  ...
  def self.acknowledge_order(create_order_acknowledgement_order, send_order_acknowledgement); end

  def self.create_events(); end
