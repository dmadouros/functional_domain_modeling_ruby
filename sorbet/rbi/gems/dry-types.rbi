...
module Dry::Types
  ...
  extend Anonymous_Dry_Core_Deprecations_Tagged_64
  extend Anonymous_Dry_Core_Deprecations_Tagged_66
  extend Anonymous_Dry_Core_Deprecations_Tagged_69
  extend Anonymous_Module_65
...
class Dry::Types::Default
  ...
  def value; end
  include Anonymous_Dry_Equalizer_71
...
module Anonymous_Dry_Equalizer_71
  def cmp?(comparator, other); end
  def freeze; end
  def hash; end
end
...
module Anonymous_Dry_Core_Deprecations_Tagged_64
end
...
module Anonymous_Dry_Core_Deprecations_Tagged_66
end
...
class Dry::Types::Compiler
  ...
  def visit_sum(node); end
  extend Anonymous_Dry_Core_Deprecations_Tagged_86
  extend Dry::Core::Deprecations::Interface
end
module Anonymous_Dry_Core_Deprecations_Tagged_86
end
